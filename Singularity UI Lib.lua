...
UIS.InputBegan:Connect(function(input, gameProcessed)
	if input.KeyCode == ((typeof(getgenv().ui_options.toggle_key) == "EnumItem") and getgenv().ui_options.toggle_key or Enum.KeyCode.RightShift) then
...
-- Beautified with Pepsi's beautifier module. (Pepsi#5229, 241586240955219969)
